...
from .QALevels import (QABERT4LGELUSkip, QADistilBert4LGELUSkip)
...
MODEL_CLASSES = {
	...
	"qabert4l" : (BertConfig, QABERT4LGELUSkip, BertTokenizer),
    "distilbert": (DistilBertConfig, DistilBertForQuestionAnswering, DistilBertTokenizer),
	"qadistilbert4l" : (DistilBertConfig, QADistilBert4LGELUSkip, DistilBertTokenizer),
}
